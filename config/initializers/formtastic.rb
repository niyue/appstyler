...
Formtastic::SemanticFormBuilder.default_hint_class = "formHint"
...
require 'appstyler/uni_form_builder'
Formtastic::SemanticFormHelper.builder = Appstyler::UniFormBuilder
